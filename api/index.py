...
# Initialize sample data function - force reinitialize for serverless
def initialize_sample_data():
    global contacts, tasks, campaigns, grants, events, wealth_screenings
    
    # Clear existing data and reinitialize for serverless environment
    contacts.clear()
    tasks.clear()
    campaigns.clear()
    grants.clear()
    events.clear()
    wealth_screenings.clear()
